      ...
      function () {
        ...
        if (t && t.length > 0)
          for (var n = 0, i = t.length; n < i; n++)
            KTDrawer.getInstance(t[n]).update();
      },
      200
    );
  }),
  ...
  if (null != e) {
    var i = {
      ...
      a = function (e) {
        null !== e &&
          !0 !== m(e) &&
          ("dropdown" === v(e) ? w(e) : "accordion" === v(e) && S(e),
          KTUtil.data(e).set("type", v(e)));
      },
      l = function (e) {
        null !== e &&
          !1 !== m(e) &&
          ("dropdown" === v(e) ? E(e) : "accordion" === v(e) && A(e));
      },
      s = function (e) {
        if (!1 !== f(e)) {
          var t = g(e);
  ...
  window.addEventListener("resize", function () {
    ...
    KTUtil.throttle(
      ...
      function () {
        ...
        if (t && t.length > 0)
          for (var n = 0, i = t.length; n < i; n++)
            KTScroll.getInstance(t[n]).update();
      },
      200
    );
  }),
  ...
  window.addEventListener("resize", function () {
    ...
    KTUtil.throttle(
      ...
      function () {
        ...
        if (t && t.length > 0)
          for (var n = 0, i = t.length; n < i; n++)
            KTSticky.getInstance(t[n]).update();
      },
      200
    );
  }),
...
(KTSwapper.getInstance = function (e) {
  ...
  (KTSwapper.createInstances = function (e) {
    var t = document.querySelectorAll(e);
    if (t && t.length > 0)
  ...
  window.addEventListener("resize", function () {
    KTUtil.throttle(
      ...
      function () {
        ...
        if (e && e.length > 0)
          for (var t = 0, n = e.length; t < n; t++)
            KTSwapper.getInstance(e[t]).update();
      },
      200
    );
  }),
